...
class Redeem implements IRouter {
  ...
  public routes(): void {
    ...
    this.router.get("/summary/hr", AccessMiddleware.wilayah, RedeemRequest.get, RedeemController.getPointSummaryByHR);
    this.router.get("/summary/region", AccessMiddleware.region, RedeemRequest.get, RedeemController.getPointSummaryByRegion);
    this.router.get("/summary/area", AccessMiddleware.area, RedeemRequest.get, RedeemController.getPointSummaryByArea);
    this.router.get("/summary/distributor", AccessMiddleware.distributor, RedeemRequest.get, RedeemController.getPointSummaryByDistributor);
    this.router.get("/summary/outlet", RedeemRequest.get, RedeemController.getPointSummaryByOutlet);
    this.router.get("/summary/asm", AccessMiddleware.area, RedeemRequest.get, RedeemController.getPointSummaryByASM);
    this.router.get("/summary/ass", AccessMiddleware.distributor, RedeemRequest.get, RedeemController.getPointSummaryByASS);
    ...
    this.router.post("/purchase-request", RedeemRequest.purchaseReq, RedeemController.purchase);
