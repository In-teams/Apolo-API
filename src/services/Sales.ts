...
class Sales {
  getTarget(req: Request): any {
    ...
    const query = db()
      ...
      .innerJoin("ms_dist_pic", "ms_outlet.distributor_id", "ms_dist_pic.distributor_id")
  ...
  getAktual(req: Request): any {
    ...
    const query = db()
      ...
      .from("trx_transaksi")
      .innerJoin("trx_transaksi_barang", "trx_transaksi.kd_transaksi", "trx_transaksi_barang.kd_transaksi")
      .innerJoin(
        "ms_outlet",
        "trx_transaksi.no_id",
        "ms_outlet.outlet_id"
